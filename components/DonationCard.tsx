...
export const DonationCard: React.FC<DonationCardProps> = ({
  ...
  const onPressHandler = () => {
    router.push({
      pathname: "/payment",
      params: { tipoPlan, cantidad, puntos },
    });
    console.log(
      `DonationCard presionada Plan: ${tipoPlan} Cantidad: ${cantidad} Puntos: ${puntos}`
    );
  };
  return (
    <TouchableHighlight style={styles.rectangleTouch} onPress={onPressHandler}>
