...
import { StripeProvider, initPaymentSheet, presentPaymentSheet, usePaymentSheet } from '@stripe/stripe-react-native';
...
const publishableKey = "pk_test_51O9qWCA1N4jj7tFywDEElSoJY86l4sLHoO5vzUeg9NB96GQJvu9E7Xv5OA9nR8ex55b9rw3GlZICsAw8EIS6lX1Y002girw2w9";
...
const DonationCard: React.FC<DonationCardProps> = ({tipoPlan, cantidad, puntos}) =>{
...
export default function Payment() {
  ...
  const [loading2, setLoading2] = useState(false);
	...
	const { response, error, create } = useUpdateCreate(
		'payment-sheet',
		{
			amount: amount2,
		}
  ...
  async function buy() {
    ...
    <View style = {styles.container}>
      ...
      <View style = {styles.loginContainer}>
        ...
        <View >
          <TouchableHighlight style = {styles.btn} onPress={buy} disabled ={loading || !ready}>
